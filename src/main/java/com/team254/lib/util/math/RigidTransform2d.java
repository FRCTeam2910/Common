...
/**
 * Represents a 2d pose (rigid position) containing translational and rotational elements.
 * 
...
public class RigidTransform2d implements Interpolable<RigidTransform2d> {
    ...
    /**
     * The inverse of this position "undoes" the effect of translating by this position.
     * 
     * @return The opposite of this position.
     */
    ...
    /**
     * Finds the point where the heading of this position intersects the heading of another. Returns (+INF, +INF) if
     * parallel.
     */
    ...
    /**
     * Return true if the heading of this position is colinear with the heading of another.
     */
    ...
    /**
     * Do twist interpolation of this position assuming constant curvature.
     */
    @Override
