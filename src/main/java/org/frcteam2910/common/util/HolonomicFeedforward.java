...
public class HolonomicFeedforward {
    ...
    public HolonomicFeedforward(
            DrivetrainFeedforwardConstants forwardConstants, DrivetrainFeedforwardConstants strafeConstants) {
    ...
    public Translation2d calculateFeedforward(Translation2d velocity, Translation2d acceleration) {
        // We don't use `DrivetrainFeedforwardConstants.calculateFeedforward` because we want to
        // apply
        // kS (the static
        ...
        // Apply the kS constant proportionally to the forward and strafe feedforwards based on
        // their
        // relative
        // magnitudes
        ...
        forwardFeedforward +=
                Math.copySign(feedforwardUnitVector.getX() * forwardConstants.getStaticConstant(), forwardFeedforward);
        strafeFeedforward +=
                Math.copySign(feedforwardUnitVector.getY() * strafeConstants.getStaticConstant(), strafeFeedforward);
