...
class SplineTest {
    ...
    void derivative() {
        ...
        // y(t) = -52x^3 - 7x + 2
        //
        // NOTE: Coefficients have to be put in the matrix in reverse order. I.e. x^3 should be in
        // the
        // last row, x^2 in
        // the second to last, and so on.
        //
        // Because we are just putting our coefficients into the weight matrix, the basis matrix
        // will
        // the the identity
        // matrix.
        Spline spline = new Spline(SimpleMatrix.identity(4), new SimpleMatrix(new double[][] {
            new double[] {-9, 2},
            new double[] {1, -7},
            new double[] {-20, 0},
            new double[] {5, -52}
